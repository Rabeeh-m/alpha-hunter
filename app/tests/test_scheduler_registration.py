...
def test_register_jobs_populates_registry():
    ...
    assert ids == {"refresh_dexscreener", "refresh_geckoterminal", "compute_alpha_scores", "scan_top_tokens_for_whale_activity", "scan_top_tokens_for_social_activity", "classify_unclassified_narratives", "scan_top_tokens_for_developer_activity"}
